                ...
                <div class="table-responsive">
                    <table class="table table-hover  m-0 table table-actions-bar">
                        ...
                        <tbody id="viewUsersDiv">
                            @include('users.templates.allUser_template')
                        </tbody>
                    </table>
                </div>
            </div>
...
@section('modals')
    ...
    @include('templates.Modals.users.permissionsModal')
    @include('templates.Modals.users.hospitalsClinicsModal')
@endsection

@section('scripts')
    @include('templates.scripts.modals')
    @include('users.scripts.userScript')
    @include('users.scripts.selectPermissionsScript')
    @include('users.scripts.selectHospitalsClinicsScripts')
@endsection
